...
194. 2026-04-03 17:45: Refreshed the AppShell architecture docs again by expanding `docs/Human-Plans/Architecture/AppShell/Future/AppShell 4 - Workspace Host Reorganization And Readability Cleanup.md` from a research baseline into a concrete future-phase ladder with explicit `Phase 1` through `Phase 6` sections, and updated `docs/Human-Plans/Architecture/AppShell/AppShell-Index.md` so the AppShell family summary now points at that named extraction order instead of only a suggested-order note
193. 2026-04-03 17:43: Refreshed the AppShell architecture docs after the first `AppShell 4` setup pass by updating `docs/Human-Plans/Architecture/AppShell/Future/AppShell 4 - Workspace Host Reorganization And Readability Cleanup.md` into a research-first lane with an explicit `Phase 0` shell audit, aligning `docs/Human-Plans/Architecture/AppShell/AppShell-Index.md` to the simpler `AppShell 4` naming, and keeping the AppShell subtree listing consistent with that renamed future phase
192. 2026-04-03 17:39: Added `docs/Human-Plans/Architecture/AppShell/Future/AppShell_Phase AppShell - Workspace Host Reorganization And Readability Cleanup.md` to the architecture docs map, refreshed `docs/Human-Plans/Architecture/AppShell/AppShell-Index.md` so the AppShell family now records the post-`Workspace 7.x` overload as a non-numbered readability and ownership cleanup lane after the shipped `5.0F` bridge work, and expanded the AppShell subtree listing so the new future phase is discoverable beside the existing shipped AppShell records
...
184. 2026-03-31 14:23: Added `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.3-1 - Second Model Viewport Runtime And Slot Truth.md` plus `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.3-2 - Per-Viewport Host Targeting And Viewer Rehome Parity.md` to the workspace docs map, refreshed `docs/Human-Plans/Architecture/Workspace-Modes/Workspace-Modes-Index.md` so the `7.3` viewer-runtime lane now reads as staged subphases, and updated the umbrella `Workspace 7` planning doc so the family ladder records that new `7.3-1` then `7.3-2` sequence
183. 2026-03-31 14:18: Added `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.3 - Multiple Model Viewports And Per-Viewport Runtime Parity.md` to the workspace docs map, refreshed `docs/Human-Plans/Architecture/Workspace-Modes/Workspace-Modes-Index.md` so the active next workspace lane now points at a dedicated `7.3` multiple-model-viewport planning surface, and updated the umbrella `Workspace 7` doc so the family ladder records that new native future phase
182. 2026-03-31 12:55: Re-homed the old `Workspace 7.2e-3` planning surface into a new `Workspace 7.2f` family by adding `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.2f - Dual-Band Edge Intent And Whole-Browser Split Signaling.md` plus staged `7.2f-1` and `7.2f-2` subphase docs, refreshed `docs/Human-Plans/Architecture/Workspace-Modes/Workspace-Modes-Index.md` so the post-`7.2e` Browser drag-language ladder now points at `7.2f`, updated the umbrella `Workspace 7` and `Workspace 7.2e` planning docs to match that rename and family split, and refreshed the workspace docs map so the old `7.2e-3` file is replaced by the new `7.2f` family
181. 2026-03-31 12:38: Added `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.2e-3 - Dual-Band Edge Intent And Whole-Browser Split Signaling.md` to the workspace docs map, refreshed `docs/Human-Plans/Architecture/Workspace-Modes/Workspace-Modes-Index.md` so the `7.2e` split-preview lane now includes the new dual-band edge-intent follow-on after `7.2e-2`, and updated the umbrella `Workspace 7.2e` planning doc so its staged read explicitly includes pane-local-versus-whole-browser split signaling
180. 2026-03-31 11:18: Added `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.2e-1 - Cursor-Driven Pane Split Preview Precision.md` plus `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.2e-2 - Adaptive Dual Ghost Nested Split Suggestions.md` to the workspace docs map, refreshed `docs/Human-Plans/Architecture/Workspace-Modes/Workspace-Modes-Index.md` so the `7.2e` split-preview lane now reads as staged subphases, and updated the umbrella `Workspace 7` planning doc so the follow-on ladder reflects that `7.2e-1` then `7.2e-2` sequence
179. 2026-03-31 11:13: Added `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.2e - Adaptive Split Preview Ghosts And Pane-Aware Nested Docking.md` to the workspace docs map, refreshed `docs/Human-Plans/Architecture/Workspace-Modes/Workspace-Modes-Index.md` so the next post-`7.2d` follow-on now captures pane-aware dual ghost split previews before `Workspace 7.3`, and updated the umbrella `Workspace 7` planning doc so the subphase ladder reflects that new `7.2e` authoring upgrade
178. 2026-03-31 11:02: Added `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.2d-2 - Browser Toolbar Claim And Rehoming Parity.md` to the workspace docs map, refreshed `docs/Human-Plans/Architecture/Workspace-Modes/Workspace-Modes-Index.md` so the active workspace cleanup lane now points at the `7.2d-2` Browser claim-parity cut after shipped `7.2d-1`, and updated the umbrella `Workspace 7` planning doc so the subphase ladder reflects that new active follow-on
177. 2026-03-31 10:47: Added `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.2d-1 - Browser Toolbar Owner State And AppShell Repoint.md` to the workspace docs map, refreshed `docs/Human-Plans/Architecture/Workspace-Modes/Workspace-Modes-Index.md` so the active workspace cleanup lane now points at the first staged `7.2d-1` structural cut, and updated the umbrella `Workspace 7` planning doc so the subphase ladder calls out that staged `7.2d` shape before `Workspace 7.3`
176. 2026-03-31 10:41: Added `docs/Human-Plans/Architecture/Workspace-Modes/Future/Workspace_Phase Workspace-7.2d - Explicit Browser Toolbar Ownership And Left-Dock Rehoming.md` to the workspace docs map, refreshed `docs/Human-Plans/Architecture/Workspace-Modes/Workspace-Modes-Index.md` so the next workspace cleanup lane now targets explicit Browser toolbar ownership after shipped `7.2c`, and updated the umbrella `Workspace 7` planning doc so its subphase ladder matches that new `7.2d` follow-on
...
##### ------------Shipped
            ...
            - `Shipped/Workspace_Phase Workspace-7.2c - Primary Viewport Left Dock Unification.md`
            - `Shipped/Workspace_Phase Workspace-7.2c-1 - Primary Viewport Left Dock Host Extraction.md`
            - `Shipped/Workspace_Phase Workspace-7.2c-2 - Left Dock Ref Repoint And Behavior Parity.md`
            - `Shipped/Workspace_Phase Workspace-7.2c-3 - Old Left Dock Shell Retirement And Cleanup.md`
            - `Shipped/Workspace_Phase Workspace-7.2d - Explicit Browser Toolbar Ownership And Left-Dock Rehoming.md`
            - `Shipped/Workspace_Phase Workspace-7.2d-1 - Browser Toolbar Owner State And AppShell Repoint.md`
            - `Shipped/Workspace_Phase Workspace-7.2d-2 - Browser Toolbar Claim And Rehoming Parity.md`
            - `Shipped/Workspace_Phase Workspace-7.2e - Adaptive Split Preview Ghosts And Pane-Aware Nested Docking.md`
            - `Shipped/Workspace_Phase Workspace-7.2e-1 - Cursor-Driven Pane Split Preview Precision.md`
            - `Shipped/Workspace_Phase Workspace-7.2e-2 - Adaptive Dual Ghost Nested Split Suggestions.md`
            - `Shipped/Workspace_Phase Workspace-7.2f - Dual-Band Edge Intent And Whole-Browser Split Signaling.md`
            - `Shipped/Workspace_Phase Workspace-7.2f-1 - Dual-Band Edge Intent State And Right-Side Proof.md`
            - `Shipped/Workspace_Phase Workspace-7.2f-2 - Four-Side Expansion And Whole-Browser Ghost Layering.md`
