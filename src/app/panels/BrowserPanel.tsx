  ...
  return (
    ...
    >
      ...
      <BrowserImportDialog
        ...
        previewSelectedRowId={overlay.stagedImportPreviewSelectedRowId}
        previewSelectedRowIds={overlay.stagedImportPreviewSelectedRowIds}
        ...
        onRemoveStagedFile={overlay.onRemoveStagedImportFile}
        onLoadPreview={overlay.onLoadStagedImportPreview}
        onSelectPreviewRow={overlay.onSelectStagedImportPreviewRow}
        ...
        canRemoveSelectedPreviewRows={overlay.canRemoveSelectedPreviewRows}
        onRemoveSelectedPreviewRows={overlay.onRemoveSelectedPreviewRows}
