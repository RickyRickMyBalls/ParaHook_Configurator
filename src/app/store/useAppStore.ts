...
import {
  DEFAULT_STAGED_IMPORT_SCALE_ALIGNMENT,
  buildInitialStagedImportPreviewOrganizationState,
  buildInitialStagedImportStructureInspectionState,
  buildStagedImportDraftFileCommitFailureMessage,
  buildStagedImportDraftFileId,
  buildStagedImportPreviewAssemblyNodeId,
  buildStagedImportPreviewComponentNodeId,
  canStagedImportFileUseMultipleObjects,
  canStagedImportPreviewNodeParentNode,
  createInitialReferenceWorkspaceState,
  pruneEmptyStagedImportPreviewAuthoredNodes,
  resolveStagedImportAcceptedTransformOverride,
  resolveStagedImportPreviewNodeIdFromTarget,
  resolveStagedImportPreviewParentTarget,
  revokeStagedImportDraftObjectUrls,
  syncStagedImportPreviewOrganizationState,
  updateStagedImportDraftFileRecord,
} from './references/referenceWorkspaceState'
import {
  DEFAULT_REFERENCE_TRANSFORM_SNAP_STATE,
  getReferenceTransformHistoryLatestScrubIndex,
  selectActiveViewerTransformTarget,
} from './transforms/referenceTransformHelpers'
import { createTransformAppStoreSlice } from './transforms/transformAppStoreSlice'
import { createWorkspaceSelectionAppStoreSlice } from './selection/workspaceSelectionAppStoreSlice'
import {
  selectEffectiveBrowserExecutionPolicy,
  selectShouldSuppressBrowserGraphRuntimeOutput,
} from './builds/appStoreBuildPolicies'
import {
...
} from './projectContent/projectContentSelectors'
export {
...
} from './selection/workspaceSelectionSelectors'
export {
  selectEffectiveBrowserExecutionPolicy,
  selectShouldSuppressBrowserGraphRuntimeOutput,
} from './builds/appStoreBuildPolicies'
...
} from './builds/appStoreBuildRequests'
...
let buildFacadeBridge: BuildFacadeBridge | null = null

export const useAppStore = create<AppState>((set, get) => ({
  ...(buildFacadeBridge = createBuildFacadeBridge({
    get,
    set,
  ...
  ...createTransformAppStoreSlice(set),
  ...
  ...createWorkspaceSelectionAppStoreSlice(set, {
...
if (buildFacadeBridge === null) {
  throw new Error('Build facade bridge failed to initialize.')
}

(buildFacadeBridge as BuildFacadeBridge).initializeSubscriptions({
